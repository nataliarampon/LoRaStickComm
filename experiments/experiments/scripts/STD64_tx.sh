...
cp ../experiments/scripts/topologies/topology64std_tx.json ./topology.json

echo 'Copying run_exercise'
cp ../experiments/scripts/run_exercise/run_exercise64std_tx.py ../utils/run_exercise.py

echo 'Coping standard proto and controllers'
cp ../standard/basic_tunnel.p4 ./ltp-proto.p4
cp ../standard/s1-runtime-tx.json ./s1-runtime.json
