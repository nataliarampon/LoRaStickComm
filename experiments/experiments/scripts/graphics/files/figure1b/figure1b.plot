...
set title "\n"
#set label 1 "Throughput UDP Link 256Kbps - 3 connections\n Payload MTU Bytes" at graph 0.5,1.225 center font "Helvetica, 30"
set xrange [0:900]
set yrange [0:500]
plot 'LTP-UDP-256k-1448b-h1-h4.txt' using 1:2 title "h1-h4" with lines lc rgb "orange" lw 2,\
     'LTP-UDP-256k-1448b-h5-h8.txt' using 1:2 title "h5-h8" with lines lc rgb "blue" lw 2,\
     'LTP-UDP-256k-1448b-h7-h2.txt' using 1:2 title "h7-h2" with lines lc rgb "green" lw 2 ##,\
##     "< paste LTP-UDP-256k-1448b-h1-h4.txt LTP-UDP-256k-1448b-h5-h8.txt LTP-UDP-256k-1448b-h7-h2.txt" using 1:($2+$4+$6) title "Agregated" with lines lc rgb "red" lw 2
unset grid
#reset
#set origin 0.21,0.5
#set size 0.3,0.25
