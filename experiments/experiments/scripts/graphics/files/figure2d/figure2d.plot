...
set title "\n"
#set label 1 "Throughput Single link with 64k, 128k, 256k\n and 512k, UDP packets of 512 bytes, with tag" at graph 0.5,1.225 center font "Helvetica, 30"
set xrange [0:900]
set yrange [0:600]
plot 'LTP-UDP-64k-512b.txt' using 1:2 title "64k" with lines lw 2,\
     'LTP-UDP-128k-512b.txt' using 1:2 title "128k" with lines lw 2,\
     'LTP-UDP-256k-512b.txt' using 1:2 title "256k" with lines lw 2,\
     'LTP-UDP-512k-512b.txt' using 1:2 title "512k" with lines lw 2
