...
set xrange [0:900]
set yrange [0:1200]
plot 'LTP-TCP-1k-88b.txt' using 1:2 title "88B" with lines lc rgb "orange" lw 2,\
     'LTP-TCP-1k-128b.txt' using 1:2 title "128B" with lines lc rgb "blue" lw 2,\
     'LTP-TCP-1k-200b.txt' using 1:2 title "200B" with lines lc rgb "purple" lw 2
