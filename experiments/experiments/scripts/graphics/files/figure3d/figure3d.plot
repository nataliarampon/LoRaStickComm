...
set grid
set multiplot
set object rectangle from 600,220 to 800,260
...
set xrange [0:900]
set yrange [0:300]
plot 'LTP-UDP-256k-1448b.txt' using 1:2 title "With LTP" with lines lw 2,\
     'STD-UDP-256k-1448b.txt' using 1:2 title "Without LTP"  with lines lw 2
unset grid
reset
...
set yrange [220:260]
set ytics (220,260) ##font "Helvetica, 15"
plot 'LTP-UDP-256k-1448b.txt' using 1:2 with lines lw 2,\
     'STD-UDP-256k-1448b.txt' using 1:2 with lines lw 2
unset multiplot
