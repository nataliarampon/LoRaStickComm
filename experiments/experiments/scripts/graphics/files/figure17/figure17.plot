...
set xrange [0:900]
set yrange [0:500]
plot 'STD-TCP-1k-128b.txt' using 1:2 title "Without LTP" with lines lc rgb "orange" lw 2,\
     'LTP-TCP-1k-128b.txt' using 1:2 title "With LTP" with lines lc rgb "orange" lw 2
