...
set xrange [0:900]
set yrange [0:500]
plot 'STD-UDP-1k-200b.txt' using 1:2 title "Without LTP" with lines lc rgb "orange" lw 2,\
     'LTP-UDP-1k-200b.txt' using 1:2 title "With LTP" with lines lc rgb "orange" lw 2
